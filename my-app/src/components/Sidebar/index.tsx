...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`fixed left-0 top-0 z-50 h-full w-72 bg-black transition-transform duration-300 ease-linear dark:bg-boxdark dark:border-2 dark:border-gray-600 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 px-6 py-5.5 lg:py-6.5">
        ...
        <button
          ...
          className="block rounded-sm bg-black p-2 text-white shadow-sm hover:bg-white hover:text-black dark:bg-black dark:text-white dark:hover:bg-white dark:hover:text-black lg:hidden transition-colors duration-300"
        >
          <svg
