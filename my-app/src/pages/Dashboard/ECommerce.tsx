...
const ECommerce: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTotalStaff = async () => {
      try {
        const response = await axios.get(
          'https://innovocode-hairsalon.com/api/User/total-staff',
        );
    ...
    const fetchTotalPrice = async () => {
      try {
        const response = await axios.get(
          'https://innovocode-hairsalon.com/api/Appointment/total-price',
        );
    ...
    const fetchTotalServices = async () => {
      try {
        const response = await axios.get(
          'https://innovocode-hairsalon.com/api/Service/total-services',
        );
    ...
    const fetchCompletedAppointments = async () => {
      try {
        const response = await axios.get(
          'https://innovocode-hairsalon.com/api/Appointment/total-completed-appointments',
        );
