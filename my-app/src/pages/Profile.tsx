...
const Profile = () => {
  ...
  const [appointments, setAppointments] = useState([
    { id: 1, date: '2024-12-18', time: '10:00 AM', description: 'Appointment1' },
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar */}
      <div className="w-1/4 bg-gray text-black p-8 rounded-l-xl shadow-lg">
        <div className="text-center mb-8">
          ...
          />
          <h2 className="text-2xl font-semibold">Laida</h2>
      ...
      {/* Main Content */}
      <div className="w-3/4 p-10 space-y-6 bg-white rounded-r-xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="mt-1 p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
        ...
        {activeSection === 'appointments' && (
          <>
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Appointments</h2>
            <div className="space-y-4">
              {appointments.map((appointment) => (
                <div key={appointment.id} className="bg-gray-100 p-4 rounded-md shadow-sm">
